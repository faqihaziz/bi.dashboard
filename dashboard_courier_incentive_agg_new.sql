...
AND DATE(oo.input_time,'Asia/Jakarta') >= DATE(DATE_ADD(CURRENT_DATE(), INTERVAL -186 DAY))
...
-- WHERE DATE(tgl_tugas) BETWEEN '2024-01-01' AND '2024-01-30'
...
courier_id,
courier_name,
DATETIME(DATE(tgl_tugas), '00:00:00') tgl_tugas,
